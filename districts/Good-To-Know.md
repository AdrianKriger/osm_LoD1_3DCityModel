...
b) Your ["Focus_area"](https://github.com/AdrianKriger/osm_LoD1_3DCityModel/blob/main/districts/osm3Ddistricts_param.json#L3) must exist in osm as a defined [boundary](https://wiki.openstreetmap.org/wiki/Key:boundary). It can be one or commaseperated. So for example should you wish to explore the nine census wards (tracts) of [Khayelitsha](https://en.wikipedia.org/wiki/Khayelitsha) (population: 400 000) you would go "Cape Town Ward 87,Cape Town Ward 89,Cape Town Ward 91,etc".
