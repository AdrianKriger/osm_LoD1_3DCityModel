...
The [code](https://github.com/AdrianKriger/osm_LoD1_3DCityModel/blob/main/osm3DCode.py#L194-L207) can easily be extended to meet your specific needs. no osm tag = no attribute. 
