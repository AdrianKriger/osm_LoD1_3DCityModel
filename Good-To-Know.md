...
b) Google ['plus codes'](https://maps.google.com/pluscodes/) are automatically generated at a precision of [12 characters (u'\u00b1'13.5-meter block size)](https://en.wikipedia.org/wiki/Open_Location_Code); referenced to the [`representative_point()`](https://shapely.readthedocs.io/en/stable/manual.html) of buildings.
