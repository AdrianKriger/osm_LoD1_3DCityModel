...
Output includes:  
    1. a 2.75D surface mesh *(buildings connected to terrain)*;  
    2. a semantically rich LoD1 City Model *(information rich building models seperate from the ground; but when connected to the terrain form a water-tight surface<sup>*</sup>)*; and  
    3. an interactive .html which you can navigate and query.
