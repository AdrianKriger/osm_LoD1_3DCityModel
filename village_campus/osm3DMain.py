...
def main():
    ...
    if jparams['roads'] == "Yes":
        ...
        one, hsr = prepareRoads(jparams, rd, pk, aoi, aoibuffer, gt_forward, rb)
    ...
    if jparams['roads'] == "Yes":
        output_cityjsonR(extent, minz, maxz, t, pts, t_list, rd_pts, jparams, min_zbld, skywalk, roof, acoi)
    else: 
    ...
    print('runtime:', str(timedelta(seconds=(end - start))))
     ...
     #-- cput runtime: 0:00:38.592168 ~ university campus: 50 buildings / with 57 roads: 0:04:16.716635
     #-- rural runtime: 0:12:51.139945 ~ rural village: population 9 000 / with 160 roads: 0:31:50.480651
     #-- neighbourhood runtime: 0:00:41.587389 ~ urban neighbourhood: population ~ 1 000, 305 buildings / with 57 roads: 0:04:34.000448
